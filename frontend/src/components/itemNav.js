      ...
      <div className="sm:flex sm:items-center justify-between">
        <div>
          <div className="flex-col items-center gap-x-3">
            <h2 className="text-lg font-medium text-gray-800 dark:text-white">{listName}단어장</h2>
            <span className="px-3 py-1 text-xs text-blue-600 bg-blue-100 rounded-full dark:bg-gray-800 dark:text-blue-400">{listNum}개</span>
          </div>
