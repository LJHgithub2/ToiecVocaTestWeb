      ...
      <form action="#" method="POST" className="mx-auto mt-16 max-w-xl sm:mt-20">
        ...
        <div className="mt-10">
          <button
            // type="submit"
            // disabled={!agreed}
            // className="block w-full rounded-md bg-my-color-600 px-3.5 py-2.5 text-center text-sm font-semibold text-white shadow-sm hover:bg-my-hover-color focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600"
            type="submit"
            ...
            ${agreed ? 'bg-my-color-600 text-white hover:bg-my-hover-color cursor-pointer' : 'bg-gray-300 text-gray-500 cursor-not-allowed'
            }`}
          disabled={!agreed}
          >
            회원가입 요청
